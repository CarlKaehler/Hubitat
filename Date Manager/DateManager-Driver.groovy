 ...
 *
 *  Design Usage:
 *  This driver formats the Date Manager data to be used with Hubitat's Dashboards.
 *
 ...
 *  Changes:
 *
 *  V1.0.0 - 07/10/20 - Initial release
 */

def setVersion(){
    appName = "DateManagerDriver"
	version = "v1.0.0" 
...
metadata {
	definition (name: "Date Manager Driver", namespace: "Compgeek", author: "Carl Kaehler") {
   		capability "Actuator"

		command "setReminder1", ["string"]
		command "setReminder2", ["string"]
...
def installed(){
    log.info "Date Manager Driver has been Installed"
    setVersion()
}

def updated() {
    log.info "Date Manager Driver has been Updated"
    setVersion()
}