...
metadata
{
	definition(name: "HubConnect Netatmo Additional Module", namespace: "Compgeek", author: "Carl Kaehler")
	{
		...
		attribute "highTemperatureToday", "string"
		attribute "lowTemperatureToday", "string"
