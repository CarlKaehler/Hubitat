...
metadata
{
	definition(name: "HubConnect Netatmo Rain", namespace: "Compgeek", author: "Carl Kaehler")
	{
		capability "Sensor"
		capability "Battery"
		capability "Refresh"
		...
		attribute "rainThisHour", "number"
		attribute "rainToday", "number"
		attribute "rainfallThisHour", "string"
		attribute "rainfallToday", "string"
